...
import { useLoginByGitHubQuery, useSignInMutation } from '@/shared/api/authApi'
...
export const SignIn = () => {
  ...
  const { data: LoginByGitHub, refetch: refetchLoginByGitHub } = useLoginByGitHubQuery()
